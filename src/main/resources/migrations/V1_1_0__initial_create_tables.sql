...
create table roles (id uuid not null, name varchar(255) not null unique, primary key (id));
create table users (id uuid not null, password varchar(255) not null, username varchar(255) not null, primary key (id));

create table users_roles (role_id uuid not null, user_id uuid not null);